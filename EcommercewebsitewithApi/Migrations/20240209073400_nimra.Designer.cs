...
namespace EcommercewebsitewithApi.Migrations
{
    ...
    [Migration("20240209073400_nimra")]
    partial class nimra
    {
            ...
            modelBuilder.Entity("EcommercewebsitewithApi.Model.Order_Details", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("order_details"), 1L, 1);
            ...
            modelBuilder.Entity("EcommercewebsitewithApi.Model.Order", b =>
                {
                    ...
                    b.HasOne("EcommercewebsitewithApi.Model.User", null)
                        .WithMany("orders")
